class Canvas {
    ...
    text(str, x, y, size = 12, color = 'black') {
        this.context.beginPath();
        this.context.font = `oblique ${size}pt cursive`;
    ...
    point(x, y, colour, size) {
        ...
        this.context.arc(this.xs(x), this.ys(y), size || 1.2, 2, 1.2 * Math.PI);
        this.context.stroke();
    }

    polygon(points, color = '#daa2f2') {
        this.context.fillStyle = color;
        this.context.beginPath();
